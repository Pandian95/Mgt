...
namespace ProjectManager.WebAPITests
{
    public class UserControllerTest
    {
        ...
        private const string ServiceBaseURL = "http://172.18.4.244/api/user/";
        ...
        public void DeleteUserInvalidIdTest()
        {
            ...
            var ex = Assert.Throws<ApiException>(() => userController.Delete(-1));
            Assert.That(ex.ErrorCode, Is.EqualTo((int)HttpStatusCode.BadRequest));
            Assert.That(ex.ErrorDescription, Is.EqualTo("Bad Request..."));
        }
        ...
        public void DeleteUserWrongIdTest()
        {
            ...
            var ex = Assert.Throws<ApiDataException>(() => userController.Delete(maxID + 1));
            Assert.That(ex.ErrorCode, Is.EqualTo(1002));
            Assert.That(ex.ErrorDescription, Is.EqualTo("User is already deleted or not exist in system."));
        }
